...
{
	/* XXX configuration */
	var val = snmp.createData({ type: 'String', value: 'node-snmpjs' });
...
{
	/* XXX introspection */
	var val = snmp.createData({ type: 'TimeTicks', value: 0 });
	snmp.util.readOnlyScalar(arg, val);
}
...
{
	/* XXX configuration */
	var val = snmp.createData({ type: 'String',
...
mib2_system_sysName(arg)
{
	...
	var val = snmp.data.createData({ type: 'String', value: nodename });
	snmp.util.readOnlyScalar(arg, val);
}
...
{
	/* XXX configuration */
	var val = snmp.createData({ type: 'String', value: 'home' });
	snmp.util.readOnlyScalar(arg, val);
}
...
{
	/* XXX configuration */
	var val = snmp.createData({ type: 'Integer', value: 72 });
	snmp.util.readOnlyScalar(arg, val);
}
